        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-12">
                ...
                <div className="col-md-12">
                    ...
                    <p>I'm a <strong>Senior Software Developer Engineer in Testing</strong> from Argentina living in New Zealand and loving every aspect of it! After 4 years of working in the local scene, I've decided to put my expertise and knowledge as a service to deliver the best testing solutions and enabling local testers and companies by teaching the ways of the Test Engineer!</p>
                    <p>As a professional coach and consultant <strong>based in the beautiful city of Wellington</strong>, I offer holistic Automation and Test Engineering courses and services for everyone. As part of my consultancy work, I perform audits to help enhance the Automation mahi (work) for my clients, delivering test assets based on each particular need. </p>
